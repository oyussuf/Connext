...
class AddPhotoGraphy extends StatefulWidget {
  const AddPhotoGraphy({Key? key}) : super(key: key);
...
class _AddPhotoGraphyState extends State<AddPhotoGraphy> {
  String dropdownValueCategory = 'Photographer';
  ...
  List<String> photoSubList = [
    'All',
    'Photo Shot',
    'Photo Editing',
  ];
  List<String> videoSubList = [
    'All',
    'Video Shot',
    'Video Editing',
  ];
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      DropdownButton<String>(
                        ...
                        onChanged: (String? newValue) {
                          ...
                          setState(() {
                            if (newValue == 'Photographer') {
                              subCategoryList = subCategoryList + photoSubList;
                            } else if (newValue == 'Videographer') {
                              subCategoryList = subCategoryList + videoSubList;
                            } else {
                              subCategoryList = subCategoryList + photoSubList;
                            }
                        ...
                        items: <String>['Photographer', 'Videographer']
