...
class _AddServiceState extends State<AddService> {
  ...
  List<String> lashesSubList = ['All', 'Extensions', 'Care'];
  List<String> bodySubList = ['All', 'Waxing', 'Body Care'];
                      ...
                      children: [
                        ...
                        DropdownButton<String>(
                          ...
                          onChanged: (String? newValue) {
                            ...
                            setState(() {
                              if (newValue == 'Hair') {
                                subCategoryList = subCategoryList + hairSubList;
                              } else if (newValue == 'Nails') {
                                subCategoryList = subCategoryList + nailSubList;
                              } else if (newValue == 'Lashes') {
                                subCategoryList =
                                    subCategoryList + lashesSubList;
                              } else if (newValue == 'Body') {
                                subCategoryList = subCategoryList + bodySubList;
                              } else {
                                subCategoryList = subCategoryList + hairSubList;
                              }
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    if (servicePriceController.text.isEmpty) {
                      displayToastMessage(
                          "Please Enter Service Price", context);
