...
class AddCooking extends StatefulWidget {
  const AddCooking({Key? key}) : super(key: key);

  @override
  State<AddCooking> createState() => _AddCookingState();
}

class _AddCookingState extends State<AddCooking> {
  String dropdownValueCategory = 'Home-Made';
  String dropdownValueSC = 'Sell Food';
  UploadTask? task;
