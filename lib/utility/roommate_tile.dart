...
class RoomMateTiles extends StatelessWidget {
  RoommatesModel roommatesModel;
  RoomMateTiles(this.roommatesModel);
  ...
  Widget build(BuildContext context) {
    picURL = roommatesModel.postedImage;
    DateTime dateTime = DateTime.parse(roommatesModel.roomMatePostedDate!);
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${roommatesModel.roomMateBedrooms}',
                        style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${roommatesModel.roomMateDistance}',
                        style: TextStyle(
                          color: Colors.black45,
                          fontWeight: FontWeight.w800,
                          fontSize: 16,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${roommatesModel.roomMatePetAllowed}',
                        style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${roommatesModel.roomMatePrefGender}',
                        style: TextStyle(
                          color: Colors.green.shade700,
                          fontWeight: FontWeight.w800,
                          fontSize: 20,
